//3. Develop a program for error detecting code using CRC-CCITT (16- bits).
...
/* Subtract the checksum from zero extended message which means we do
simple "XORing" */
for (x=mlen; x< mlen + glen - 1; x++)
t[x]= cs[x - mlen];
System.out.println("Final codeword generated is: "+ new String(t));
System.out.println("innTest Error detection 1(yes) 0(no) ? : ");
test = in.nextInt();
if (test==1){
